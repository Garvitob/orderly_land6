...
export const TICKET: readonly (TicketLine & { at: string })[] = [
  ...
  { id: "i1", at: "modes", left: "1× btr chkn", kind: "item" },
  { id: "i1m", at: "modes", left: "› mild", kind: "mod" },
  { id: "i2", at: "numbers", left: "1× kofta", kind: "item" },
  { id: "i3", at: "break", left: "1× lassi", kind: "item" },
  { id: "i4", at: "journey", left: "1× naan", kind: "item" },
